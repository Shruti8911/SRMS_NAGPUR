...
<h1 style="color:#000000" align="center">Update Marks</h1>
            ...
            <form name="frmreg" method="post" action="update_d5_marks_query.php" onsubmit ="return check();" >
...
$query = "SELECT subject_id FROM d5_details where enroll_no='$enroll_no'";
...
$query1="SELECT enroll_no from d5_details where enroll_no=$enroll_no ";
...
$query="SELECT * from d5_details where enroll_no=$enroll_no and subject_id=$subject_id";
...
<tr><td><b>Performance in Group Activity(Out of 6)</b></td>
<td><input type="text" name="perform" value="<?php echo $perform?>"  size="5"/></td>
</tr>

<tr><td><b>Individual Performance in Oral / Presentation (Out of 4)</b></td>
<td><input type="text" name="indivi_perform" value="<?php echo $indivi_perform ?>"  size="5"/></td>
