...
<div class="main">
  ...
  <div class="content">
    ...
    <p>&nbsp;</p>
	<form name="frm" method="post" action="insert_stud.php">
	<center><h2>Student Registration </h2>
	 <table style="width: 450px" border="2">
	<tr>
	<td>
	<b style="color:#990000">Student Name</b>
	</td>	
	<td>
	<input type="text" name="stud_name" style="width:253px;" />
	</td>
	</tr>
	<tr>
	<td>
	<b style="color:#990000">Roll No</b>
	</td>	
	<td>
	<input type="text" name="roll_no" style="width:253px;" />
	</td>
	</tr>
	
	<tr>
	<td>
	<b style="color:#990000">Enrollment No</b>
	</td>	
	<td>
	<input type="text" name="enroll_no" style="width:253px;" />
	</td>
	</tr>
	<tr>
	<td>
	<b style="color:#990000">Exam Seat No. No</b>
	</td>	
	<td>
	<input type="text" name="seat_no" style="width:253px;" />
	</td>
	</tr>
	<?php
