...
<div class="main">
  ...
  <div class="content">
    ...
    <p>&nbsp;</p>
	<form name="frm" method="post" action="insert_staff.php">
	...
	<td>
	<input type="text" name="staff_name" style="width:253px;" />
	</td>
	</tr>
	
	<tr>
	<td>
	<b style="color:#990000">Email Id</b>
	</td>	
	<td>
	<input type="text" name="email" style="width:253px;" />
	</td>
	</tr>
...
<td>
	...
	<td>
	<b style="color:#990000">About Him/Her</b>
	</td>	
	<td>
	<input type="text" name="about" style="width:253px;" />
	</td>
	</tr>
	</table>
