...
<div class="main">
  ...
  <form action="insert_class.php" method="post">
	...
	<center><h2>Add Class Details</h2><p>
	<b>
   ...
   include('config.php');
	...
	<tr><td><label><b style="color:#990000">Select Course</b> </label></td><td><select name="c_id" id="class">
	...
	<tr> 
	<td><b style="color:#990000">Enter Class</b></td><td style="size:500"><input type="text" name="class_name" width="500" /></td>
	</tr>
	<tr>
