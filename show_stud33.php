...
<div class="main">
 ...
 <h4 style="color:#FF0000">Note: This DELETE option is to delete all subjects marks of a particular student.</h4>
...
{                                                
	...
	<b style="color:#000000"><a href="delete_marks.php?id=<?php echo $row['stud_id'];?>"><b>DELETE MARKS</b></a></b>
	</td>
