...
<div class="main">
  ...
  <div class="content">
  <form action="insert_course_code.php" method="post">
    <p>&nbsp;</p>
	
	<center><h2>Add Course Code</h2><p>
	<b>
   ...
   include('config.php');
	...
	<tr><td><label><b style="color:#990000">Select Course</b> </label></td><td><select name="c_id" id="c_id">
	...
	<tr> 
	<td><b style="color:#990000">Enter Course Code</b></td><td style="size:500"><input type="text" name="cr_code" width="500" /></td>
	</tr>
	<tr>
