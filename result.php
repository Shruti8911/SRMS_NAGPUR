...
<div class="main">
  ...
  <div class="content">
    ...
    <p>&nbsp;</p>
	<form name="frm" method="post" action="show_result.php">
	<center><h2>Enter Details</h2><p>
	 <table style="width: 450px" border="2">
	<tr>
	
	<td>
	<b style="color:#990000">Enter Roll No.</b>
	</td>	
	<td>
...
include('config.php');
   ...
   <td><select name="c_id" id="c_id">
	...
	<tr>
	<td>
	<b style="color:#990000">Select Class *</b>
</td>
<td>
	...
	<tr><td><b style="color:#990000">Select Exam *</b></td><td>
	...
	<td>
	<b style="color:#990000">Enter Session</b>
	</td>	
	<td>
