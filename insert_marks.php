...
$query="SELECT stud_id from studvsmarks where roll_no=$roll_no and exam_id=$exam_id and subject_id=$subject_id";
...
{
$insert = "INSERT INTO studVSmarks VALUES('$studVSmarks_id','$stud_id','$roll_no','$stud_name','$class_id','$exam_id','$subject_id','$marks_obt','$marks_out_of')";
