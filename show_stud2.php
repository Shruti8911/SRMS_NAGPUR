...
<form name="frm" method="post" action="insert_d4.php">
<center>
 <h2 align="center">Add D4 Details</h2><br />
 
<table width="65%" border="1" bgcolor="#FFFFFF">
...
<tr>
   ...
   <?php
	...
	<select name="stud_name" id="stud_name">
     ...
     <tr>
	<td >
	<b style="color:#990000">Marks Obtained in Oral/ Practical Exam As per T E Scheme. Max Marks(   )</b>
	</td>
	<td>
	
	 <input type="text" name="marks_obt" value="" size="10" />
