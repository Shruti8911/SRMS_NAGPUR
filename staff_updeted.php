...
$insert = "UPDATE registration SET allumini_name='$allumini_name',address='$address',gender='$gender',dob='$dob',contact_no='$contact_no',email_id='$email_id',education='$education',job='$job',org='$org' WHERE email_id='$email_id'";
