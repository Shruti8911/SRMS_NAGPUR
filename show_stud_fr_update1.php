...
<b>
          ...
          <td><b style="color:#FF0000">Subject Code</b></td>
		   ...
		   <td><b style="color:#FF0000">Marks Obtained</b></td>
...
$query="SELECT * from d4_details where c_id=$c_id and class_id=$class_id and subject_id='$subject_id' and subject_code='$subject_code' order by roll_no";
...
{                                                
	...
	<b style="color:#000000"><a href="update_d4_marks.php?id=<?php echo $row['enroll_no'];?>"><b>UPDATE</b></a></b></td>
	<td>
	<b style="color:#000000"><a href="delete_d4_marks.php?id=<?php echo $row['enroll_no'];?>"><b>DELETE</b></a></b>
	</td>
