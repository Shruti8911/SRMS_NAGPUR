...
$TS1=$_POST['TS1'];
$TS2=$_POST['TS2'];
$avg_marks=$_POST['avg_marks'];
$perform=$_POST['perform'];
$indivi_perform=$_POST['indivi_perform'];
$total=$avg_marks+$perform+$indivi_perform;

//echo "$roll_no";

$query="SELECT roll_no from d5_details where roll_no=$roll_no";
...
{
$insert = "INSERT INTO d5_details VALUES  ('$d5_id','$academic_yr','$staff_name','$c_id','$class_id','$subject_id','$subject_code','$semister','$username','$roll_no','$stud_name','$enroll_no','$exam_seat_no','$TS1','$TS2','$avg_marks','$perform','$indivi_perform','$total')";
