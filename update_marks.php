...
$query="SELECT * from studvsmarks where stud_id=$stud_id and subject_id=$subject_id";
...
$query2="SELECT exam_name from exam where exam_id=$exam_id";
$results2 = mysql_query($query2)
...
<tr><td><b>Student Name</b></td><td><input type="text" name="stud_name" value="<?php echo $stud_name?>" size="50" disabled="disabled"/></td></tr>
<input type="hidden" name="stud_id" value="<?php echo $stud_id?>" />

<tr><td><b>Class</b></td><td><input type="text" name="class_name" value="<?php echo $class_name?>" size="50" disabled="disabled"/>
...
<tr><td><b>Exam</b></td><td><input type="text" name="exam_name" value="<?php echo $exam_name?>" size="50" disabled="disabled"/>
