...
<div class="main">
  ...
  <div class="content">
    ...
    <p>&nbsp;</p>
	<form name="frm" method="post" action="show_stud_fr_update1.php">
	<center><h2>Show D4 Details</h2>
  ...
  ?>
    ...
    //Count total number of rows
	$count22 = mysql_num_rows($run_query2);
	if($count22 > 0)
	{
            while($row2 = mysql_fetch_array($run_query2)){
