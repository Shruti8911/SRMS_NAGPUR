...
$query="SELECT exam_id from exam where ucase(trim(exam_name))=ucase('$exam_name')";
...
$insert = "INSERT INTO exam VALUES  ('$exam_id','$class_id','$exam_name')";
